    ...
    <section id="features" class="py-20">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass-card p-8 rounded-xl text-center reveal delay-100">
                ...
                <div class="glass-card p-8 rounded-xl text-center reveal delay-200">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                    <div class="flex flex-col items-center reveal">
                        <div class="w-24 h-24 rounded-full bg-blue-500/20 border-2 border-blue-400 flex items-center justify-center text-blue-300 text-3xl font-bold mb-4 z-10">1</div>
                    ...
                    <div class="flex flex-col items-center reveal delay-100">
                        <div class="w-24 h-24 rounded-full bg-blue-500/20 border-2 border-blue-400 flex items-center justify-center text-blue-300 text-3xl font-bold mb-4 z-10">2</div>
                    ...
                    <div class="flex flex-col items-center reveal delay-200">
                        <div class="w-24 h-24 rounded-full bg-blue-500/20 border-2 border-blue-400 flex items-center justify-center text-blue-300 text-3xl font-bold mb-4 z-10">3</div>
    ...
    <section id="courses" class="py-20 bg-gray-900">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="course-card reveal delay-100">
                ...
                <div class="course-card reveal delay-200">
    ...
    <section id="about" class="py-20">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
                ...
                <div class="about-card reveal delay-100">
                ...
                <div class="about-card reveal delay-200">
                ...
                <div class="about-card reveal delay-300">
