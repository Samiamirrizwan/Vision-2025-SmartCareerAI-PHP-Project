            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://twitter.com/SmartCareerAi/status/1743096488300106013" class="text-2xl hover:text-blue-400 transition"><i class="fa-brands fa-x-twitter"></i></a>
                        <a href="https://www.instagram.com/corementor.in/" class="text-2xl hover:text-purple-500 transition"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
