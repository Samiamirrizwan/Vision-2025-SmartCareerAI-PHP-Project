document.addEventListener('DOMContentLoaded', () => {
    console.log("SmartCareerAI JS Initialized");
        ...
        // --- NEW: Preloader and Page Load Animation ---
    const preloader = document.getElementById('preloader');
    if (preloader) {
        window.addEventListener('load', () => {
            document.body.classList.add('loaded'); // Trigger content animations
            preloader.classList.add('preloader-hidden'); // Start preloader fade out
